...
# doc's weight "vector". (See more detailed below)
...
# synonyms
#
# array of sets which are classified as synonyms
# used for query expension
...
## CS Courses Corpus
##
## This function overrides the following data structures
##  1. docs_freq_hash
##  2. corp_freq_hash
##  3. doc_vector
## 
## Using documents and corpus from CS Courses website
##
##########################################################
...
for i in range(len(course_title)):
    ...
    titles_vector.append(str(course_title[i].get_text().strip()))
...
## to_TF_IDF_weighting
##
## A function that changes converts doc_vector[ doc_num ][ term ]
## which is by default Raw_TF_weighting, to TF_IDF_weighting
##
##  docs_freq_hash[term] = number of documents that has the 'term'
##  corp_freq_hash[term] = number of 'term' occurances in corpus
##
##########################################################
